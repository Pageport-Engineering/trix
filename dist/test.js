...
var repository = {
	type: "git",
	url: "git+https://github.com/Pageport-Engineering/trix.git"
};
var keywords = [
	"rich text",
	"wysiwyg",
...
var license = "MIT";
var bugs = {
	url: "https://github.com/Pageport-Engineering/trix/issues"
};
...
class AttachmentEditorController extends BasicObject {
  constructor(attachmentPiece, _element, container) {
    ...
    _defineProperty(this, "addToolbar", undoable(() => {
      ...
      const element = makeElement({
        tagName: "div",
        className: [css$1.attachmentToolbar, "flex", "justify-center"].join(" "),
        data: {
          trixMutable: true
        },
